...
export const generateReceiptJSX = (order: Order, config: ReceiptConfig = defaultConfig) => {
  return (
...
export const printReceipt = async (order: Order, config: ReceiptConfig = defaultConfig): Promise<boolean> => {
  try {
...
export const generateReceiptContent = (order: Order, config: ReceiptConfig = defaultConfig): string => {
  let receipt = '';
